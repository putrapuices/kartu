...
?>
 ...
 <div id="m_aside_left" class="m-grid__item	m-aside-left  m-aside-left--skin-blue ">
					<!-- BEGIN: Aside Menu -->
	<div id="m_ver_menu" class="m-aside-menu  m-aside-menu--skin-blue m-aside-menu--submenu-skin-dark " m-menu-vertical="1" m-menu-scrollable="0" m-menu-dropdown-timeout="500">
