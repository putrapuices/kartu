...
<div class="row">
  ...
  <!-- email dimatikan dlu. input email awal di ambil dari table user, ketika melakukan register -->
<!-- <div class="col-md-6">
 <div class="form-group">
 ...
 <div class="col-md-4">   
  <?= $form->field($model, 'keterangan_status', [
    'template' =>'{label}<br/>{input}{error}'
  ],['active' => true])->radioList(['1'=>'Belum Kawin','2'=>'Kawin'],['tag'=>'div','value'=>true,'required'=>true,'style' => 'display:inline','separator'=>'<br/>'])->label('Status Nikah');?>
</div> 
<div class="form-group">
  <div class="col-md-6" style="line-height: 2em;"> 
    <hr/>
    <i>
     Data Provinsi, Kota dan Kecamatan, Di isi sesuai E-KTP.
   </i>
 </div>
 <div class=" col-sm-6">         
  <?php
  ...
  <div class="box-header">
    ...
    <?php if($carilokasi):?>
      <?php if (Yii::$app->user->identity->level == 40) {?>
       <a href="kartu" target="_blank"         class="btn box-solid box-danger"style="font-size:20px;color:black"><i class="fa fa-print"></i> <b> Print Depan Kartu AK I</b></a>
       <a href="kartubelakang" target="_blank" class="btn box-solid box-danger"style="font-size:20px;color:black"><i class="fa fa-print"></i> <b> Print Belakang Kartu AK I</b></a>
