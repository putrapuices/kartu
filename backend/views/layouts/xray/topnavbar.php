                     ...
                     <ul class="navbar-list">
                        <li>
                           <a href="#" class="search-toggle iq-waves-effect d-flex align-items-center">
                              ...
                              <?=Html::img($imgPath.'/themes2/images/user/01.jpg',['class'=>'img-fluid rounded mr-3'],['alt'=>'user']); ?>
                              <div class="caption">
                           ...
                           <div class="iq-sub-dropdown iq-user-dropdown">
                              <div class="iq-card shadow-none m-0">
                               ...
                               <?= Html::a(
                                    'Sign Out',
                                    ['/site/logout'],                                    ['data-method' => 'post', 'class' => 'bg-primary iq-sign-btn btn btn-primary ri-login-box-line ml-2']
                                ) ?>
                            </div>
