...
// }
     ...
     public function actionCreatetabular()
    {
        ...
        $model = new Pengalaman();       
          // $nisn = Biosiswa::find()->where(['biosiswa_nis' => $id])->one();        
          // $biosiswa_id = Biosiswa::find()->where(['biosiswa_id' => $id])->one(); 
...
// foreach ($modelsAddress as $keyindexx=>$modelKandidatt) 
//                             {
//                                 // if ($modelKandidatt->image = UploadedFile::getInstance($modelKandidatt, "[{$keyindexx}]image")) { 
//                                 //     $imageName = date('dmyhis_').$id;
//                                 //     $imageNamee = date('dmyhis_').$id.'ccc';
                               

//                                 // $modelKandidatt->image->saveAs('../../public/login/files/prestasisiswa_nama/'.$imageName.'.'.$modelKandidatt->image->extension);

//                                 // $modelKandidatt->prestasisiswa_file = $imageName.'.'.$modelKandidatt->image->extension;
//                                 // $modelKandidatt->prestasisiswa_nama = $imageNamee.'.'.$modelKandidatt->image->extension;
...
//                 // $modelOptionValue->image = \yii\web\UploadedFile::getInstance($modelOptionValue, "[{$index}]image");
//             }
