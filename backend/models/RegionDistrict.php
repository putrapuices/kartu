...
class RegionDistrict extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['name'], 'string', 'max' => 255],
            [['city_id'], 'exist', 'skipOnError' => true, 'targetClass' => RegionCity::className(), 'targetAttribute' => ['city_id' => 'id']],
        ];
    }
    ...
    {
        return $this->hasMany(RegionSubdistrict::className(), ['district_id' => 'id']);
    }
}
