...
class RegionCity extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['name'], 'string', 'max' => 255],
            [['province_id'], 'exist', 'skipOnError' => true, 'targetClass' => RegionProvince::className(), 'targetAttribute' => ['province_id' => 'id']],
        ];
    }
    ...
    {
        return $this->hasOne(RegionProvince::className(), ['id' => 'province_id']);
    }
    ...
    {
        return $this->hasMany(RegionDistrict::className(), ['city_id' => 'id']);
    }
}
